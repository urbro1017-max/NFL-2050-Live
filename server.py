...
VERSION="66.0"
BUILD_NAME="ATLAS 66.0 FOOTBALL INTELLIGENCE OS"
...
def atlas_ai_ask(question):
    ...
    req=Request("https://api.openai.com/v1/responses",data=json.dumps(payload).encode(),headers={"Authorization":"Bearer "+OPENAI_API_KEY,"Content-Type":"application/json","User-Agent":"ATLAS/66.0"},method="POST")
    t=time.perf_counter()
    try:
...
class H(SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if u.path=="/api/build":return self.sendj({"ok":True,"version":VERSION,"build":BUILD_NAME,"js":"atlas66.js","css":"atlas66.css","database":STORE.kind,"ai":atlas_ai_status()})
