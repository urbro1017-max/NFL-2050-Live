...
VERSION="64.0"
BUILD_NAME="ATLAS 64.0 NEON INTELLIGENCE"
...
def atlas_ai_ask(question):
    ...
    req=Request("https://api.openai.com/v1/responses",data=json.dumps(payload).encode(),headers={"Authorization":"Bearer "+OPENAI_API_KEY,"Content-Type":"application/json","User-Agent":"ATLAS/64.0"},method="POST")
    t=time.perf_counter()
    try:
